...
-- N: p == cur_proj
  ...
  if item then
    ...
    local fadein, fadeout = chunk:match'FADEIN 1.1 ', chunk:match'FADEOUT 1.1 '
        ...
        for i = 0, tr_items-1 do
          ...
          if tr_item ~= item then
            ...
            if tr_it_start < it_end and tr_it_end > it_end and it_end - tr_it_start >= crfade then
              ...
              local before, val, after = chunk:match'(FADEOUT 1.1 %S+ )(%S+)( .-\n)'
              ...
              if val ~= crfade then
                ...
                local before, val, after = chunk_2:match'(FADEIN 1.1 %S+ )(%S+)( .-\n)'
        ...
        for i = 0, tr_items-1 do
          ...
          if tr_item ~= item then
            ...
            if it_start < tr_it_end and it_end > tr_it_end and tr_it_end - it_start >= crfade then
              ...
              local before, val, after = chunk:match'(FADEIN 1.1 %S+ )(%S+)( .-\n)'
              ...
              if val ~= crfade then
                ...
                local _, chunk_2 = r.GetItemStateChunk(tr_item, 0, 0)
                local before, val, after = chunk_2:match'(FADEOUT 1.1 %S+ )(%S+)( .-\n)'
                local chunk_2 = chunk_2:gsub(before..val..after, before..crfade..after)
