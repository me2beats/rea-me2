...
if tracks > 0 then
  ...
  for i = 0, tracks-1 do
    ...
    tr_name_ansi = Utf8ToAnsi(tr_name)
    if tr_name_ansi then
      tr_name_ansi_lower = tr_name_ansi:lower()
      tr_name_utf_lower = AnsiToUtf8(tr_name_ansi_lower)
      reaper.GetSetMediaTrackInfo_String(tr, 'P_NAME', tr_name_utf_lower, 1)
    end
  end
